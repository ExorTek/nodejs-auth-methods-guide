...
import { authRoutes, mfaRoutes } from './routes/index.js';
...
app.register(mfaRoutes, { prefix: '/api/mfa' });

app.get('/api/health', async (request, reply) => reply.code(200).send({ status: 'ok', uptime: process.uptime() }));
