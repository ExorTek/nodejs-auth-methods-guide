 ...
 * MFA-aware: if user has MFA enabled and hasn't verified yet,
 * the access token includes mfaPending: true
 */
const createTokenPair = async ({ userId, username, mfaVerified = true, req }) => {
